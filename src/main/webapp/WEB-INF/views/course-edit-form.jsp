...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/user/courses/details/${course.id}"> ${course.name} Details </a></li>
        <li class="breadcrumb-item active" aria-current="page"> ${course.name} Edit</li>
    </ol>
</nav>
...
<div class="container">
    <div class="card mx-auto mt-3">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center align-items-center container ">
                <div class="form-group col-md-8">
                    <form:label path="organizedBy"
                                class="col-form-label"> Organized By:</form:label>
            ...
            <div class="d-flex justify-content-center align-items-center container ">
                <div class="form-group col-md-8">
                    <form:label path="finishDate"
                                class="col-form-label"> Ends On: </form:label>
            ...
            <div class="d-flex justify-content-center align-items-center container ">
                <div class="form-group col-md-8">
                    <form:label path="topics" class="col-form-label"> Topics:</form:label>
                    <form:select path="topics" class="form-control" items="${course.topics}" multiple="multiple"
                                 selected="selected"/>
            ...
            <div class="d-flex justify-content-center align-items-center container ">
                <div class="col-md-8 text-center mt-3">
                    ...
                    <a href="/user/courses/details/${course.id}" class="btn btn-block btn-link" role="button"> Discard </a>
