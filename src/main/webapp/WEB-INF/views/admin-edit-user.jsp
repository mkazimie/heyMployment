...
<div class="container">
    <div class="card mx-auto mt-3">
        <div class="card-header bg-dark display-5 text-white text-center"> Edit user</div>
        <div class="card-body">
            <form:form method="post" modelAttribute="user" action="/admin/users/edit/">
            ...
            <div class="form-check form-check-inline">
                <form:label path="roles" class="col-md-4 col-form-label text-md-center"> Set Role: </form:label>
